...
import com.myprotect.projectx.common.Constants.KEY_IOS_FIREBASE_NOTIFICATION
...
import com.myprotect.projectx.notifications.PayloadData
...
internal fun NotifierManager.onNotificationActionClicked(action: String) {
    NotifierManagerImpl.onNotificationActionClicked(action)
}
